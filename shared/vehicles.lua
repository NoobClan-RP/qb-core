...
local Vehicles = {
    ...
    { model = 'blazer2',       name = 'Blazer Lifeguard',              brand = 'Nagasaki',        price = 7000,    category = 'offroad',        type = 'bike',       shop = 'pdm' }, -- type edited for garage
    ...
    { model = 'policeb',       name = 'Police Bike',                   brand = 'Vapid',           price = 110000,  category = 'emergency',      type = 'bike',       shop = 'none' },
    { model = 'polmav',        name = 'Police Maverick',               brand = 'Buckingham',      price = 110000,  category = 'emergency',      type = 'heli',       shop = 'none' },
    ...
    { model = 'seashark2',     name = 'Seashark Lifeguard',            brand = 'Speedophile',     price = 40000,   category = 'emergency',      type = 'boat',       shop = 'none' },
    ...
    { model = 'predator',      name = 'Police Predator',               brand = 'Unknown',         price = 40000,   category = 'emergency',      type = 'boat',       shop = 'none' },
    { model = 'police5',       name = 'Stanier LE Cruiser',            brand = 'Vapid',           price = 40000,   category = 'emergency',      type = 'automobile', shop = 'none' },
    -- dlc: cops & crooks
    { model = 'polimpaler5',   name = 'Impaler SZ Cruiser',            brand = 'Declasse',        price = 40000,   category = 'emergency',      type = 'automobile', shop = 'none' },
    { model = 'polimpaler6',   name = 'Impaler LX Cruiser',            brand = 'Declasse',        price = 40000,   category = 'emergency',      type = 'automobile', shop = 'none' },
    { model = 'poldominator10',name = 'Dominator FX Cruiser',          brand = 'Vapid',           price = 40000,   category = 'emergency',      type = 'automobile', shop = 'none' },
    { model = 'poldorado',     name = 'Dorado Cruiser',                brand = 'Bravado',         price = 40000,   category = 'emergency',      type = 'automobile', shop = 'none' },
    { model = 'policet3',      name = 'Burrito (Bail Enforcement)',    brand = 'Declasse',        price = 40000,   category = 'emergency',      type = 'automobile', shop = 'none' },
    { model = 'polgreenwood',  name = 'Greenwood Cruiser',             brand = 'Bravado',         price = 40000,   category = 'emergency',      type = 'automobile', shop = 'none' },
    { model = 'polgauntlet',   name = 'Gauntlet Interceptor',          brand = 'Bravado',         price = 40000,   category = 'emergency',      type = 'automobile', shop = 'none' },
    -- fib
    { model = 'fibp2',         name = 'FIB Buffalo',                   brand = 'Bravado',         price = 40000,   category = 'emergency',      type = 'automobile', shop = 'none' },
    { model = 'fibp6',         name = 'FIB Scout',                     brand = 'Vapid',           price = 40000,   category = 'emergency',      type = 'automobile', shop = 'none' },
    --- Military (19)
